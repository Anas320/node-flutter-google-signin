...
import 'package:google_signin_example/page/Authenticated.dart';
import 'package:google_signin_example/page/Signup.dart';
                ...
                GestureDetector(
                  onTap: () async {
                    ...
                    var request = http.Request(
                        'POST',
                        Uri.parse(
                            'https://aqueous-thicket-70637.herokuapp.com/auth/login'));
                    request.body =
